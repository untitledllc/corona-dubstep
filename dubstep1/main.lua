...
local backRect = display.newRoundedRect(0, 0, w, h, 64)
local but1 = display.newRoundedRect(w/8,h/6,3*w/4,28,12)
local but2 = display.newRoundedRect(w/8,h/3,3*w/4,28,12)
local but3 = display.newRoundedRect(w/8,h/2,3*w/4,28,12)
local recBut = display.newRoundedRect(w/8,2*h/3,3*w/4,28,12)
local repBut = display.newRoundedRect(w/8,5*h/6,3*w/4,28,12)

local textBut1 = display.newText("Track1 is stopped", w/8, h/6+3, native.systemFont, 16)
local textBut2 = display.newText("Track2 is stopped", w/8, h/3+3, native.systemFont, 16)
local textBut3 = display.newText("Track3 is stopped", w/8, h/2+3, native.systemFont, 16)
local textRecBut = display.newText("Recording is stopped", w/8, 2*h/3+3, native.systemFont, 16)
local textRepBut = display.newText("Replaying is stopped", w/8, 5*h/6+3, native.systemFont, 16)
